                ...
                <div className="max-w-[100rem] mx-auto w-full space-y-6 animate-fade-in-up flex-1">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white dark:bg-[#1e293b] p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 gap-4">
                        ...
                        <div className="flex items-center space-x-3 w-full md:w-auto">
                            ...
                            <button onClick={() => setPrintDoc({ isOpen: true, type: activeTab, data: (activeTab === 'aging_customers' ? customerAgingReport : supplierAgingReport).filter(r => hideZeroAging ? r.netDue !== 0 : true) })} className="px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg shadow-blue-500/30 hover:scale-95 transition-all flex items-center shrink-0">
